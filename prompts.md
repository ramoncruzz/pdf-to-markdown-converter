...
> 4.  **CLI**: Use `argparse` para receber o arquivo de entrada e opcionalmente o arquivo de saída.
...
>     -   Entrada: Arquivo binário (multipart/form-data).
>     -   Ação: Processar o PDF recebido utilizando a lógica de conversão e OCR existente.
...
>     -   Entrada: JSON contendo uma URL (ex: `{"url": "http://exemplo.com/arquivo.pdf"}`).
>     -   Ação: Baixar o arquivo temporariamente, processá-lo e converter.
